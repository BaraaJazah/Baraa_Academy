    ...
    <div style=" height: 100vh ; padding :5vh">
        ...
        <div class="card col-md-12 col-lg-10" style="padding: 10px ; margin: auto; ">
            ...
            <div class="" style="display: flex ;padding:20px 20px; justify-content: space-between; align-items: center ">
                <span style="" class="text-muted"></span>


                <span style="" id = "timeDown" class="text-muted"></span>
        ...
        <div class=" layout-content-navbar"
            ...
            <div class="col-md-12 col-lg-6"
                ...
                <div class="left"
                    ...
                    <form action="{{ route('student.finish' , $id) }}" method="POST">
                        @csrf
                        @method('POST')
                            ...
                            <div id="{{ $j++ }}" class="card" style="width : 100% ;  height: 70vh">
                                <div class="nav-align-top ">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <button type="button" class="nav-link active" role="tab"
                                                data-bs-toggle="tab" data-bs-target="#text{{ $questionData->id }}"
                                                aria-controls="text{{ $questionData->id }}" aria-selected="true">
                                                {{ __('user.Text') }}
                                            </button>
                                        </li>
                                        <li class="nav-item">
                                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                                data-bs-target="#image{{ $questionData->id }}" aria-controls="image{{ $questionData->id }}"
                                                aria-selected="false">
                                                {{ __('user.Image') }}
                                            </button>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div style="height: 220px" class="tab-pane fade active show " id="text{{ $questionData->id }}"
                                            role="tabpanel">
                                        ...
                                        <div style="height: 220px" class="tab-pane fade  " id="image{{ $questionData->id }}"
                                            role="tabpanel">
