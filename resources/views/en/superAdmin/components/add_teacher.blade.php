...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add Settings /</span> Add Teacher</h4>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card mb-4">
          ...
          <hr class="my-0">
          <div class="card-body">
            <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('register4')}}">
              @method('POST')
              @csrf
              <div class="mb-3">
              ...
              <button class="btn btn-primary d-grid w-100">Add Teacher</button>
            </form>
          </div>
          <!-- /Account -->
        </div>
  ...
  @if (Session::has("addmessage"))
    ...
    <div class="bs-toast toast fade show bg-success  screen2" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
          ...
          <div class="me-auto fw-semibold">Teacher</div>
